  ...
  <div class="bg-white px-6 py-32 lg:px-8">
    <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
      ...
      <p class="mt-6 text-xl leading-8">
        At Protege, we take your privacy seriously. This privacy policy describes how we collect, use, and protect your personal information.
      </p>
      <div class="mt-10 max-w-2xl">
        ...
        <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
          ...
          <li class="flex gap-x-3">
            ...
            <span>Resume and portfolio content</span>
          </li>
          <li class="flex gap-x-3">
            <svg class="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
        ...
        <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
          ...
          <li class="flex gap-x-3">
            ...
            <span>Analyze and improve our platform</span>
          </li>
        </ul>
      </div>
    </div>
