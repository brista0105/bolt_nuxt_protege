<template>
  <div class="bg-white px-6 py-32 lg:px-8">
    <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
      <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Cookie Policy</h1>
      <p class="mt-6 text-xl leading-8">
        This Cookie Policy explains how Protege uses cookies and similar technologies to recognize you when you visit our website.
      </p>
      <div class="mt-10 max-w-2xl">
        <h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">What are cookies?</h2>
        <p class="mt-6">
        ...
        <h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">How we use cookies</h2>
        <p class="mt-6">
